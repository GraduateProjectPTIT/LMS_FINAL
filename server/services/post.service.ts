  ...
  try {
    ...
    const items = rawItems.map((p: any) => {
      ...
      return {
        ...
        authorId: p.authorId || { name: "Deleted User", avatar: { url: "https://cdn-icons-png.flaticon.com/512/1077/1077114.png" } },
  ...
  try {
    ...
    const items = rawItems.map((p: any) => {
      ...
      return {
        ...
        authorId: p.authorId || { name: "Deleted User", _id: "deleted", avatar: { url: "https://cdn-icons-png.flaticon.com/512/1077/1077114.png" } },
        coverImage: p.coverImage?.url ? { url: p.coverImage.url } : p.coverImage,
        shortDescription,
        views: typeof (p as any).views === "number" ? (p as any).views : 0,
        readingTimeMinutes,
