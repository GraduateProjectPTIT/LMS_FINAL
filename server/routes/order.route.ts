...
import { createOrder, getAdminOrders, getUserOrders, getPaidOrders, getAdminOrderDetail, getTutorOrders, getTutorOrderDetail, getUserOrderDetail } from "../controllers/order.controller";
...
orderRouter.get("/order/get_user_order_detail/:id", isAuthenticated, getUserOrderDetail);
