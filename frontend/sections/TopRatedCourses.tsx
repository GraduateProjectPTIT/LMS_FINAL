...
const TopRatedCourses = () => {
    ...
    const [courses, setCourses] = useState<ITopRatedCourse[]>([]);
    ...
    const fetchTopRatedCourses = async () => {
        try {
            setLoading(true);
            const res = await fetch(`${process.env.NEXT_PUBLIC_BACKEND_BASEURL}/api/course/top-rated?limit=${limit}`, {
                method: 'GET',
                headers: {
            ...
            if (!res.ok) {
                throw new Error(data.message || 'Failed to fetch top rated courses');
            }
            ...
            <div className='container max-w-6xl px-4 mx-auto'>
                <div className="text-center mb-12">
                    ...
                    <p className="text-gray-600 dark:text-gray-400">
                        Explore our highest rated courses loved by students worldwide
                    </p>
                </div>
