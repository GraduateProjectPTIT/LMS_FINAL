...
const EditCourseInformation = ({ courseInfo, setCourseInfo, active, setActive, thumbnailPreview, setThumbnailPreview }: EditCourseInformationProps) => {
