...
const RecommendedCourses = () => {
    ...
    const handleFetchRecommendedCourses = async () => {
        try {
            const res = await fetch(`${process.env.NEXT_PUBLIC_BACKEND_BASEURL}/api/recommendations`, {
                method: "GET",
                headers: {
            ...
            if (!res.ok) {
                throw new Error(data.message || "Cannot fetch recommended courses");
            }
            ...
            <div className='container max-w-6xl px-4 mx-auto'>
                <div className="text-center mb-12">
                    ...
                    <p className="text-gray-600 dark:text-gray-400">
                        Discover courses specially recommended based on your interests and learning history.
                    </p>
                </div>
