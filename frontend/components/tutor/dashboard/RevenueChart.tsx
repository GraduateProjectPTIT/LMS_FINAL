    ...
    const fetchRevenueData = async (range: "30d" | "12m") => {
        try {
            ...
            const res = await fetch(
                `${process.env.NEXT_PUBLIC_BACKEND_BASEURL}/api/tutor/dashboard/earnings?range=${range}`,
                {
                    method: "GET",
                    headers: {
            ...
            console.error("Earnings error:", error?.message || error);
        } finally {
            setLoading(false);
        }
    };
            ...
            return (
                <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-lg p-3">
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-300">
                        Earnings: <span className="font-medium text-emerald-600">${payload[0].value.toLocaleString()}</span>
                    </p>
                </div>
            );
        }
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <div>
                        ...
                        <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
                            Track your course earnings over time
                        </p>
                    </div>
