...
interface EditVideoUploaderProps {
    video?: IVideoUpload;
    isUploading: boolean;
...
const EditVideoUploader = ({
    ...
    // Kiểm tra đã upload video thành công chưa và có video hay chưa
    const hasUploadedVideo = video && video.public_id && video.url && video.public_id !== "" && video.url !== "";

    const [showPreviewModal, setShowPreviewModal] = useState(false);

    // Nếu đã upload video thành công và upload xong
    ...
    // Mặc định chưa có video nào được upload
    return (
