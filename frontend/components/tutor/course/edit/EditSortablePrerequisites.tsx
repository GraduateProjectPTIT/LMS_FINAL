...
interface EditSortablePrerequisitesItemProps {
    id: string;
...
const EditSortablePrerequisitesItem = ({
    id,
    prerequisite,
    index,
    onRemove,
}: EditSortablePrerequisitesItemProps) => {
...
export default EditSortablePrerequisitesItem;