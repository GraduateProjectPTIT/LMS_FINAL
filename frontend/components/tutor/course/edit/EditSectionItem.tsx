...
import EditLectureItem from './EditLectureItem';
...
interface EditSectionItemProps {
...
const EditSectionItem = ({
    ...
    const getLectureId = (lecture: IEditLecture) => {
        return lecture._id || lecture.id || '';
    };
    ...
    return (
        ...
        >
            ...
            >
                <SortableContext
                    items={section.sectionContents.map(lecture => getLectureId(lecture))}
