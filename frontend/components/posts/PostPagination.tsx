        ...
        <div className="flex items-center justify-center gap-1 my-12">
            ...
            <button
                ...
                className={` flex items-center justify-center w-9 h-9 rounded-md transition-colors
                    ${currentPage === 1
                        ...
                        : 'bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 border hover:bg-gray-100 dark:hover:bg-gray-700 cursor-pointer'
                    }`}
            >
            ...
            {getPageNumbers().map((page, index) => (
                <button
                    ...
                    disabled={page === '...'}
                    className={` flex items-center justify-center min-w-9 h-9 px-2 rounded-md text-sm font-medium transition-colors
                        ${page === currentPage
